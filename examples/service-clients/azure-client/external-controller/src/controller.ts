	...
	implements IDiceRollerController
{
	...
	constructor(
		...
		private readonly onSet: (value: DiceValues) => void,
	) {
		super();
	...
	public readonly roll = (): void => {
		const rollValue = (Math.floor(Math.random() * 6) + 1) as DiceValues;
